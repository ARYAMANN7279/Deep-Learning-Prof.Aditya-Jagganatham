...
california = datasets.load_california_housing()
...
ytrainPredict=reg.predict(X_train)
mse=mean_squared_error(y_train,ytrainPredict)
r2=r2_score(y_train,ytrainPredict)
